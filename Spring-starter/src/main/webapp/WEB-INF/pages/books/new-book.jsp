...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $('#newBookForm').submit(function(event) {
    	  ...
    	  var json = { "title" : title, "description" : description, "price": price, "author": author};
    	  
        $.ajax({
        	url: $("#newBookForm").attr( "action"),
...
<form:form id="newBookForm" action="${pageContext.request.contextPath}/books/create.json" commandName="sBook">
<table>
<tbody>
<tr>
<td>Title:</td>
