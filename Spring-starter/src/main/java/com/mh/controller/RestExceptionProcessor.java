...
public class RestExceptionProcessor {
	...
	@ResponseBody
	public ErrorInfo bookNotFound(HttpServletRequest req, BookNotFoundException ex) {
		
		String errorMessage = localizeErrorMessage("error.no.book.id");
		
		errorMessage += ex.getBookId();
